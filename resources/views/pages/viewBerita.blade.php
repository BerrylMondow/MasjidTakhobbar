...
@section('content')
    ...
    <div class="container news-container mb-4">
        ...
        <div class="my-4 text-center">
            <img src="{{ asset('storage/berita/' . $berita->gambar) }}" class="img-fluid rounded img-berita"
                alt="Gambar Berita">
        ...
        {{-- KATA KUNCI --}}
        <div class="keywords-container mt-4">
            <p class="fw-bold fs-5 me-2 text-primary keywords-label">Kata Kunci:</p>
            <p class="fs-5 fw-bold keywords-list">{{ $berita->keyword }}</p>
        </div>
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="share-icons d-flex">
                <a href="#"><img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="Facebook"
                        title="Facebook"></a>
                <a href="#"><img src="https://cdn-icons-png.flaticon.com/512/2111/2111728.png" alt="WhatsApp"
                        title="WhatsApp"></a>
                <a href="#"><img src="https://cdn-icons-png.flaticon.com/512/3046/3046122.png" alt="TikTok"
                        title="TikTok"></a>
            </div>
        </div>
    </div>
